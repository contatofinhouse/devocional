...
# Roteiro com +2 segundos em todas as pausas de silêncio
PHASES = [
    {
        "id": 1,
...
async def main():
    ...
    print("🎙️ Gerando falas individuais com pausas ampliadas (+2s)...")
    for idx, p in enumerate(PHASES):
        ...
        # Generate exact silence samples (+2s)
    ...
    print(f"\n✅ Áudio atualizado salvo em: {final_wav_path}")
    print(f"⏱️ Duração total ampliada: {total_duration_sec}s (~{total_duration_sec // 60}m {total_duration_sec % 60}s)")
